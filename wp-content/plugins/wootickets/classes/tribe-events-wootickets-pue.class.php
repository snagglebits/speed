<?php
/**
 * Manage upgrades for the Tribe Events Woo Tickets plugin
 *
...
if( !class_exists( 'TribeEventsWooticketsPUE' ) ) {
	class TribeEventsWooticketsPUE {

		/**
		 * @var string slug used for the plugin update engine
		 */
		private static $pue_slug = 'tribe-wootickets';
