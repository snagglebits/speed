...
<div id="wrapper" class="wrapper-content <?php echo get_option("ocmx_site_layout"); ?> <?php if( !is_active_sidebar( 'slider' ) ) echo "no-slider"; ?>">
	...
	<div id="content-container" class="<?php if(is_tax('product_cat') || is_post_type_archive('product') || is_singular('product') || is_page() && wp_basename( get_page_template() ) == 'shop-sidebar-page.php') : echo get_option("ocmx_shop_sidebar_layout"); else : echo get_option("ocmx_sidebar_layout"); endif;?> clearfix">