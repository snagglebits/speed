    ...
    function widget($args, $instance) {
		...
		echo $before_widget; ?>
			<?php echo $before_title; ?>
            	<a href="https://www.facebook.com/<?php if( isset( $facebookpage ) ) echo $facebookpage; ?>" target="_blank"><?php if( isset( $title ) ) echo $title; ?></a>
            <?php echo $after_title; ?>

            <iframe src="//www.facebook.com/plugins/likebox.php?href=http%3A%2F%2Fwww.facebook.com%2F<?php if( isset( $facebookpage ) ) echo $facebookpage; ?>&amp;width=300&amp;height=<?php if( isset( $height ) ) echo $height; ?>&amp;show_faces=<?php if( isset( $faces ) ) echo $faces; ?>&amp;colorscheme=light&amp;stream=<?php if( isset( $stream ) ) echo $stream; ?>&amp;border_color&amp;header=false&amp;appId=289052711225982" scrolling="no" frameborder="0" style="width:100%; height:<?php if( isset( $height ) ) echo $height; ?>px;" allowTransparency="true"></iframe>
        ...
        ?>
            ...
            <p>
            	<label for="<?php echo $this->get_field_id('facebookpage'); ?>">
                	Facebook Page Name
                	<input class="widefat" id="<?php echo $this->get_field_id('facebookpage'); ?>" name="<?php echo $this->get_field_name('facebookpage'); ?>" type="text" value="<?php if( isset( $facebookpage ) ) echo $facebookpage; ?>" />
            ...
            <p>
            	<label for="<?php echo $this->get_field_id('height'); ?>">
	                Height (in pixels)
            		<input class="widefat" id="<?php echo $this->get_field_id('height'); ?>" name="<?php echo $this->get_field_name('height'); ?>" type="text" value="<?php if( isset( $height ) ) echo $height; ?>" />
